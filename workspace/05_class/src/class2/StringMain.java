...
public class StringMain {
	...
	public static void main(String[] args) {
		...
		String a = "apple";//literal 생성 heap영역에 생상된다 주소 값;.. - 이름 부여X, - 생성, 삭제(JVM)
		...
		System.out.println("문자열 크기 = "+ e.length()); //문자열의 크기는 () 들어감
		for(int i=0; i<e.length();i++) {
			System.out.println(i + " : "+e.charAt(i));
		}//for
		System.out.println("부분 문자열 추출="+e.substring(7));
		System.out.println("부분 문자열 추출="+e.substring(7,11)); // 7~10번 까지
		...
		System.out.println("문자열 검색="+e.indexOf("바보")); // -1
